...
namespace SchoolWebApp.Infrastructure.Migrations
{
    ...
    [Migration("20240702144302_Added Fields to Staff Details")]
    partial class AddedFieldstoStaffDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolWebApp.Core.Entities.Identity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1302),
                            CreatedBy = "admin",
                            Modified = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1338),
                            ModifiedBy = "admin",
                            Name = "Administrator",
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1455),
                            CreatedBy = "admin",
                            Modified = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1474),
                            ModifiedBy = "admin",
                            Name = "HeadTeacher",
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1554),
                            CreatedBy = "admin",
                            Modified = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1558),
                            ModifiedBy = "admin",
                            Name = "Teacher",
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1638),
                            CreatedBy = "admin",
                            Modified = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1640),
                            ModifiedBy = "admin",
                            Name = "Student",
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1700),
                            CreatedBy = "admin",
                            Modified = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1703),
                            ModifiedBy = "admin",
                            Name = "Parent",
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1765),
                            CreatedBy = "admin",
                            Modified = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1788),
                            ModifiedBy = "admin",
                            Name = "Accounts",
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1855),
                            CreatedBy = "admin",
                            Modified = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(1860),
                            ModifiedBy = "admin",
                            Name = "Visitor",
            ...
            modelBuilder.Entity("SchoolWebApp.Core.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bef56cb6-bd7c-42c1-8751-bdddc65ee974",
                            Created = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(2034),
                            CreatedBy = "admin",
                            ...
                            Modified = new DateTime(2024, 7, 2, 17, 43, 0, 923, DateTimeKind.Local).AddTicks(2036),
                            ModifiedBy = "admin",
                            NormalizedEmail = "ADMIN@KODETEK.CO.KE",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEEzO+kQYeL58J9yCay8QSI5maTw21hUs9T5Bm/N6a8jV3CC0KnHkyTOEcp0ZyfuzWA==",
                            PersonId = 5,
                            PhoneNumber = "+254724920000",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "4f317d58-f476-4bb5-ba8f-fa73efee91f3",
